...
INSERT INTO topic (keyword_id, content, writer, photo) VALUES (1, "��ö�� ����� �ĺ��� ���̾�� �������� ��� ���Ͻó���??", "�̰���", "http://");
INSERT INTO topic (keyword_id, content, writer, photo) VALUES (1, "����� ���� �ɱ��?? ��ö��, ������ ,�ڱ���??", "�ڼ���", "http://");
...
INSERT INTO users VALUES(1,'lge920904','LeeGaeul','1234',"http");